export class ROICalculator {
    private static AVG_ORDER_VALUE = 2500; // Example average order value
    private static HANDLING_COST = 150;    // Cost to process a return (shipping + labor)

    public static calculateSavedRevenue(preventedReturns: number): number {
